                    ...
                    <div class="login-box" style="min-height: 700px;" >
                        <div class="login-snip"> <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Admin Login</label> <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"></label>
                            <div class="login-space">
                                <div class="login">
                                    <form action="admin-login.php" method="post">
                                        <div class="group"> <label for="name="username"" class="label">Admin username</label>
                                        ...
                                        <div class="hr"></div>
                                        <div class="foot"> <label for="tab-1"><a style="color:#fff" href="login.php">Login as user. <br/> Click here</a></label> </div>
                                        ...
                                        if (isset($_POST["submit"])) {
                                            ...
                                            if (emptyInputLogin($userName, $pw) !== false) {
                                                echo '<h5Input place cannot be empty.</h5>';
                                                exit();
                                            }

                                            loginAdmin($conn, $userName, $pw);
                                        }
                                        ?>
                                      </form>
                                </div>
